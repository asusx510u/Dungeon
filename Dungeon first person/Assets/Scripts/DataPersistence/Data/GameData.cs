...
public class GameData
{
    ...
    public void SetSceneData(SceneData info)
    {
        ...
        if(info.name != Constant.mainMenuSceneName)
        {
    ...
    public class Globals
    {
        ...
        //public List<Item> itemList; // INVENTORY !!
        public Globals()
        {
            this.deathCount = 0;
            healthAmount = 100;
            //itemList = new List<Item>(); // INVENTORY !!
            lastSceneName = Constant.firstPlayableSceneName;
        }
    }
